...
master_log_name = 'Max{0}_{1}by{2}_Log'.format(max_attempt, given_steps, given_stepsize)
ark_dict_file = None
ThermoJob = True
        ...
        if not exists_and_complete(geo_Freq_Log):
            if attempt>1:
                ...
                if not os.path.isfile(geo_Freq_Com):
                    assert False, "Protecting my mems. Delete this for a complete disregard of your mems"
                    lowest_conf = None
            ...
            if not using_lowest:
                ...
                continue #Ark stuff done broke with this verison of statmech
                ...
                if not os.path.isfile(species_file):
                    ...
                    #print "\nWould have calculated thermo data\n"
                    #log += ['Would have calculated thermo data']
                ...
                #all_Scans_Verified is False, but using lowest energy conformer
